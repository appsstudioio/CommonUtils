...
extension Combine.Publishers.ControlProperty {
    private final class Subscription<S: Subscriber, CControl: UIControl, CValue>: Combine.Subscription where S.Input == CValue {
        private var subscriber: S?
        weak private var control: CControl?
        let keyPath: KeyPath<CControl, CValue>
        private var didEmitInitial = false
        private let event: CControl.Event

        init(subscriber: S, control: CControl, event: CControl.Event, keyPath: KeyPath<CControl, CValue>) {
